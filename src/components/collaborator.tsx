...
export default function CollaboratorsTab({ collaborators, accreditations, disabled }: { collaborators: AppType['collaborators']; accreditations: AccreditationType[]; disabled: boolean }) {
	return (
			...
			{collaborators.map((collaborator) => {
				return (
					<li key={collaborator.username} className="bg-[#18181a] rounded-lg flex justify-between px-4 py-3 items-center h-[68px] border-l-4 border-blue-500">
						...
						<div className="flex items-center justify-start space-x-3 text-gray-500">
						...
						<Select defaultValue={collaborator.accreditation.slug} disabled={true} onValueChange={(value) => console.log(value)}>
