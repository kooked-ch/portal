...
export const UpdateApp = ({ description, repository }: FormData) => {
	...
	const {
		...
		defaultValues: { repository, description },
	});
			...
			<DialogContent tabIndex={-1}>
				<form onSubmit={handleSubmit(onSubmit)} className="flex flex-col">
					<DialogHeader className="mb-5">
						...
						<DialogDescription>Update the description and the repository of your project.</DialogDescription>
					</DialogHeader>

					<div className="space-y-4">
						<div className="space-y-2">
							<Label htmlFor="description">Description</Label>
							<Input tabIndex={1} id="description" {...register('description')} />
							{errors.description && <p className="text-red-500 text-sm">{errors.description.message}</p>}
						</div>
						<div className="space-y-2">
							<Label htmlFor="repository">App Repository</Label>
							<Input tabIndex={2} id="repository" {...register('repository')} />
