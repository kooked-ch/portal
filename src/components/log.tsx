	...
	return (
		<div className="space-y-4">
			<div className="flex gap-2">
				...
				<Button variant="outline" size="sm" className="flex items-center justify-start h-9 w-32" onClick={() => setDateRange((prev) => (prev === 7 ? 30 : 7))}>
				...
				{filteredLogs.length > 0 ? (
					<ul className="space-y-2">
						{filteredLogs.map((log, index) => (
							<li key={index} className="flex items-center justify-between border-b border-[#333] pb-2">
